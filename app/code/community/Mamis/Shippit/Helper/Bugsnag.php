...
class Mamis_Shippit_Helper_Bugsnag extends Mage_Core_Helper_Abstract
{
    ...
    public function init()
    {
        if (!$this->client) {
            if (file_exists(Mage::getBaseDir('lib') . '/shippit-bugsnag/Autoload.php')) {
                ...
                Mage::log('Shippit Bugsnag Error: Couldn\'t activate Bugsnag Error Monitoring due to missing Bugsnag PHP library!');
    ...
    public function getModuleInfo()
    {
        return array(
            'name' => 'Mamis_Shippit',
            'version' => Mage::helper('mamis_shippit')->getModuleVersion(),
        );
    }
